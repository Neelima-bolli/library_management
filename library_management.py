class Library:
    ...
    def borrowBook(self, name, bookname):
        if bookname not in self.books:
            print(
                f"{bookname} BOOK IS NOT AVAILABLE EITHER TAKEN BY SOMEONE ELSE, WAIT UNTIL PERSON RETURNED.\n")
        else:
...
class Student():
    def requestBook(self):
        ...
        self.book = input("Enter name of the book you want: ")
        return self.book
...
if __name__ == "__main__":
    ...
    Delhilibrary = Library(
        ["vistas", "invention", "rich&poor", "indian", "macroeconomics", "microeconomics","CORE PYTHON","C PROGRAMMING","DBMS","OPPS","JAVA PROGRAMMING","WEB DEVELOPMENT","APTITUDE","APPLIED PHYSICS"])
    student = Student()
    track = []
